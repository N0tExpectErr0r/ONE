...
import com.nullptr.one.moduleMovie.detail.IMovieDetail.MovieInfoModel;
import com.nullptr.one.moduleMovie.detail.IMovieDetail.OnMovieInfoListener;
import com.nullptr.one.moduleMovie.detail.db.MovieInfoBaseHelper;
        ...
        if (cursor.getCount() > 1) {
            ...
            new Thread(new Runnable() {
                ...
                public void run() {
                    ...
                    movieInfo.setMovieTitle(
                            cursor.getString(cursor.getColumnIndex(Cols.MOVIE_TITLE)));
