package com.nullptr.one.moduleArticle.list.presenter;

import android.os.Handler;
import android.os.Looper;
import com.nullptr.one.bean.Article;
import com.nullptr.one.moduleArticle.list.IArticleList.ArticleListModel;
import com.nullptr.one.moduleArticle.list.IArticleList.ArticleListPresenter;
import com.nullptr.one.moduleArticle.list.IArticleList.ArticleListView;
import com.nullptr.one.moduleArticle.list.IArticleList.OnArticleListListener;
import com.nullptr.one.moduleArticle.list.IArticleList.OnMoreArticleListener;
import com.nullptr.one.moduleArticle.list.model.ArticleListModelImpl;
